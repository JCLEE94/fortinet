...
def check_remaining_hardcoding():
    ...
    main_files = ['src/main.py', 'src/web_app.py', 'src/api/clients/fortimanager_api_client.py']
    ...
    for file_path in main_files:
        ...
        for pattern, description in patterns_to_avoid:
            if pattern in content and 'os.getenv' not in content[max(0, content.find(pattern)-50):content.find(pattern)+50]:
