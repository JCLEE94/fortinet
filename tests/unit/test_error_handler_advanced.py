...
class TestApplicationError:
    ...
    def test_application_error_basic_initialization(self):
        ...
        from core.error_handler_advanced import ApplicationError, ErrorSeverity, ErrorCategory
    ...
    def test_application_error_full_initialization(self):
        ...
        from core.error_handler_advanced import (
            ApplicationError, ErrorSeverity, ErrorCategory, ErrorContext
        )
...
class TestErrorRecoveryStrategy:
    ...
    def test_error_recovery_strategy_can_handle_basic(self):
        ...
        from core.error_handler_advanced import (
            ErrorRecoveryStrategy, ApplicationError, ErrorSeverity, ErrorCategory
        )
        ...
        with patch.object(strategy, '_can_handle_category', return_value=True), \
            ...
            # Non-recoverable should return False
    ...
    def test_error_recovery_strategy_success_history_check(self):
        ...
        from core.error_handler_advanced import (
            ErrorRecoveryStrategy, ApplicationError, ErrorCategory
        )
    ...
    def test_error_recovery_strategy_exception_handling(self):
        ...
        from core.error_handler_advanced import (
            ErrorRecoveryStrategy, ApplicationError
        )
        ...
        with patch.object(strategy, '_can_handle_category', side_effect=Exception("Test exception")), \
...
class TestErrorHandlerIntegration:
    ...
    def test_error_context_preservation(self):
        ...
        from core.error_handler_advanced import (
            ApplicationError, ErrorContext, ErrorCategory
        )
