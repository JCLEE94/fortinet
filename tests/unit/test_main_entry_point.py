...
class TestEnvironmentDetection:
    ...
    def test_get_env_port_dev(self):
        ...
        with patch('main.APP_CONFIG', {'web_port': 7777}), \
             patch.dict(os.environ, {'DEV_PORT': '8080'}):
    ...
    def test_get_env_port_prod(self):
        ...
        with patch('main.APP_CONFIG', {'web_port': 7777}), \
             patch.dict(os.environ, {'PRD_PORT': '9090'}):
            from main import get_env_port
...
class TestWebInterfaceMode:
    ...
    def test_main_web_mode_with_socketio(self, mock_settings, mock_load_env, mock_validate, 
                                        mock_docker, mock_port, mock_env, mock_create_app):
    ...
    @patch('main.load_environment_config')
    @patch('main.unified_settings')
    def test_main_web_mode_without_socketio(self, mock_settings, mock_load_env, mock_validate,
                                           mock_port, mock_env, mock_create_app):
...
class TestCLIMode:
    ...
    @patch('main.validate_environment_consistency')
    @patch('main.load_environment_config')
    def test_main_cli_mode_success(self, mock_load_env, mock_validate, mock_client_class, 
                                  mock_save, mock_visualize, mock_analyze):
    ...
    @patch('main.validate_environment_consistency')
    @patch('main.load_environment_config')
    def test_main_cli_mode_no_output_file(self, mock_load_env, mock_validate, mock_client_class, 
                                         mock_visualize, mock_analyze):
...
class TestIntegrationScenarios:
    ...
    @patch('main.visualize_path')
    @patch('main.FortiGateAPIClient')
    def test_production_cli_analysis(self, mock_client_class, mock_visualize, mock_analyze, 
                                   mock_validate, mock_load_env):
        ...
        test_args = [
            ...
            '--port', '3306',
            '--protocol', 'tcp',
            '--host', 'fortigate-prod.company.com',
        ...
        with patch('sys.argv', test_args), \
            ...
            mock_analyze.assert_called_once_with(
                '10.1.1.100', '172.16.1.50', 3306, 'tcp', mock_client, False
            )
            mock_visualize.assert_called_once()
