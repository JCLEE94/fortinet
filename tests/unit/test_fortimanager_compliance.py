        ...
        try:
            ...
            with patch.object(checker, 'rule_manager') as mock_rule_mgr:
                mock_rule_mgr.get_all_rules.return_value = [
                    Mock(id='rule1', category='security')
                ]
    ...
    async def test_run_full_compliance_check(self):
        ...
        try:
            ...
            with patch('fortimanager.fortimanager_compliance_automation.ComplianceChecker') as mock_checker_cls:
                ...
                with patch('fortimanager.fortimanager_compliance_automation.ComplianceReportGenerator') as mock_report_cls:
                    mock_reporter = Mock()
