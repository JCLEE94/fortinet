...
class TestSystemRoutes:
    ...
    def test_health_check_basic(self):
        ...
        with patch('routes.api_modules.system_routes.unified_settings', self.mock_settings), \
    ...
    def test_health_check_with_build_info(self):
        ...
        build_info_data = {
            "gitops": {
                "immutable": True,
                "principles": ["Declarative", "Versioned", "Immutable", "Pulled"]
            },
            "build": {
                "immutable_tag": "v1.0.0-abc123",
            ...
            "registry": {
                "full_image": "registry.jclee.me/fortinet:v1.0.0"
            }
        }
    ...
    def test_system_stats_endpoint(self):
        ...
        with patch('routes.api_modules.system_routes.get_cpu_usage', return_value=25.5), \
...
class TestSystemRoutesSecurity:
    ...
    def test_health_check_no_sensitive_info(self):
        ...
        with patch('routes.api_modules.system_routes.unified_settings', Mock()), \
             patch('routes.api_modules.system_routes.get_system_uptime', return_value=3600), \
             patch('routes.api_modules.system_routes.format_uptime', return_value="1 hour"), \
             patch('routes.api_modules.system_routes.os.path.exists', return_value=False):
...
class TestSystemRoutesErrorHandling:
    ...
    def test_health_check_with_system_error(self):
        ...
        with patch('routes.api_modules.system_routes.get_system_uptime', side_effect=Exception("System error")), \
    ...
    def test_health_check_file_read_error(self):
        ...
        with patch('routes.api_modules.system_routes.os.path.exists', return_value=True), \
