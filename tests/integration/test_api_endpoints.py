...
def test_api_endpoints():
    ...
    with app.test_client() as client:
        ...
        try:
            ...
            response = client.post('/api/fortimanager/analyze-packet-path',
                                 json=test_data,
        ...
        try:
            ...
            response = client.post('/api/fortimanager/advanced/analytics/trends',
                                 json=test_data,
                                 content_type='application/json')
        ...
        try:
            ...
            response = client.post('/api/fortimanager/advanced/compliance/check',
                                 json=test_data,
                                 content_type='application/json')
