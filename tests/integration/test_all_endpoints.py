...
class APITester:
    ...
    def run_all_tests(self):
        ...
        endpoints = [
            ...
            ('/api/fortimanager/analyze-packet-path', 'POST', {
        ...
        for base_url in self.base_urls:
            ...
            for endpoint, method, data, description in endpoints:
                ...
                if 'error' in result:
                    ...
                    print(f"  {status_color} {result['status_code']} - {result['response_time']}ms - {result['content_type']}")
