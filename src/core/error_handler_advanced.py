...
class ErrorHandler:
    ...
    def _convert_to_application_error(self, error: Exception, 
                                     context: ErrorContext = None) -> ApplicationError:
...
def async_handle_errors(severity: ErrorSeverity = ErrorSeverity.ERROR,
                       category: ErrorCategory = ErrorCategory.UNKNOWN):
