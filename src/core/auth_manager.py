...
class AuthManager:
    ...
    def authenticate(self, host: str, port: int, auth_type: AuthType, 
                    **kwargs) -> Tuple[bool, Optional[AuthSession]]:
        """
    ...
    def _authenticate_fortigate_api_key(self, host: str, port: int, 
                                       api_key: str, **kwargs) -> Tuple[bool, Optional[AuthSession]]:
        """
    ...
    def _authenticate_fortigate_basic(self, host: str, port: int,
    ...
    def _authenticate_fortimanager(self, host: str, port: int,
                                  username: str, password: str,
                                  **kwargs) -> Tuple[bool, Optional[AuthSession]]:
        """
    ...
    def _authenticate_bearer_token(self, host: str, port: int,
                                  token: str, **kwargs) -> Tuple[bool, Optional[AuthSession]]:
        """
