...
class CacheManager:
    ...
    def __init__(self, backends: Optional[List[CacheBackend]] = None,
    ...
    def set(self, key: str, value: Any, ttl: Optional[int] = None,
            backends: Optional[List[CacheBackend]] = None) -> bool:
        """
        Set value in cache.
    ...
    def _populate_lower_caches(self, key: str, value: Any, source_backend: CacheBackend):
        ...
        if (source_backend == CacheBackend.REDIS and 
            CacheBackend.MEMORY in self._backends):
