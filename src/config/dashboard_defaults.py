    ...
    "total_devices": int(os.getenv("DEFAULT_TOTAL_DEVICES", "48")),
                         "uptime_percentage": float(os.getenv("DEFAULT_UPTIME_PERCENTAGE", "99.8")),
                                                    "network_traffic": os.getenv("DEFAULT_NETWORK_TRAFFIC", "2.4 Gbps"),
                                                                                 "active_alerts": int(
                                                                                                      os.getenv("DEFAULT_ACTIVE_ALERTS",
                                                                                                                                                               "3")
                                                                )
                                                              "trend_device_increase": int(
                                                                                           os.getenv("DEFAULT_TREND_DEVICE_INCREASE",
                                                                                                     "12"))
                                                 )
                                                                                  "trend_uptime_increase": float(
                                                                                                                 os.getenv("DEFAULT_TREND_UPTIME_INCREASE",
                                                                                                                           "0.2"))
                                             )
                                                                                      "trend_traffic_decrease": int(
                                                                                                                    os.getenv("DEFAULT_TREND_TRAFFIC_DECREASE",
                                                                                                                              "8"))
                                               )
                                           }
                                                               ...
                                                               "description_template": os.getenv(
                                                                                                 "ALERT_CRITICAL_DESC",
                                                                                                     "{device}에서 CPU 사용률이 {threshold}%를 초과했습니다.",
                                                                                                                            ...
                                                                                                                            "threshold": int(
                                                                                                                                             os.getenv("CPU_CRITICAL_THRESHOLD",
                                                                                                                                                 "85"))
                                                              )
                                         },
                                             {
                                                                           ...
                                                                           "description_template": os.getenv(
                                                                                                 "ALERT_WARNING_DESC",
                                                                                                     "{device}에서 메모리 사용률이 {threshold}%를 초과했습니다.",
                                                                                                                            ...
                                                                                                                            "threshold": int(
                                                                                                                                             os.getenv("MEMORY_WARNING_THRESHOLD",
                                                                                                                                                 "75"))
                                                              )
                                         },
                                             {
...
REFRESH_CONFIG = {
    "auto_refresh_enabled": os.getenv("DASHBOARD_AUTO_REFRESH", "true").lower() == "true",
                                      "refresh_interval_seconds": int(os.getenv("DASHBOARD_REFRESH_INTERVAL", "30")),
                                                                      "chart_update_interval": int(
                                                                                                   os.getenv("CHART_UPDATE_INTERVAL",
                                                                                                                                                                                   "60")
                                                                      )
                                                                                                                                          "stats_update_interval": int(
                                                                                                                                                                       os.getenv("STATS_UPDATE_INTERVAL",
                                                                                                                                                                                 "15")
                                                                     )
                                                                      }
                    ...
                    "color": template["color"],
                        "title": template["title_template"],
                            "description": template["description_template"].format(
                                                                                   device=device, threshold=template.get(
                                                                                                                         "threshold",
                                                                                                                             75
                                                                               )
                                                                           ),
