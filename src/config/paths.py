...
DEFAULT_BASE_DIR = (
                    "/app" if os.path.exists("/app") else os.path.dirname(
                        ...
                        "error": os.path.join(APP_PATHS["logs"], "error.log"),
                                              "access": os.path.join(APP_PATHS["logs"], "access.log"),
                                                                 ...
                                                                 "audit": os.path.join(APP_PATHS["logs"], "audit.log"),
                                                                                       "fortigate": os.path.join(
                                                                                                                 APP_PATHS["logs"],
                                                                                                                                                          "fortigate.log"
                                                              )
                                                                                                                                            "fortimanager": os.path.join(
                                                                                                                                                                         APP_PATHS["logs"],
                                                                                                                                                                             "fortimanager.log"
                                                                      )
                                                                   }
                             ...
                             "syslog": os.path.join(SYSTEM_LOG_BASE, "syslog"),
                                                "messages": os.path.join(SYSTEM_LOG_BASE, "messages"),
                                                                         "docker": os.path.join(
                                                                               ...
                                                                               "nginx_access": os.path.join(
                                                                                                            SYSTEM_LOG_BASE,
                                                                                                                                                         "nginx",
                                                                                                                                                             "access.log"
                                                            )
                                                                                                                                            "nginx_error": os.path.join(
                                                                                                                                                                        SYSTEM_LOG_BASE,
                                                                                                                                                                            "nginx",
                                                                                                                                                                                "error.log"
                                                                      )
