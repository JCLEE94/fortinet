...
DATATABLE_LANGUAGE = {
    "search": os.getenv("DATATABLE_SEARCH_TEXT", "검색:"),
                        "lengthMenu": os.getenv("DATATABLE_LENGTH_MENU", "_MENU_ 개씩 보기"),
                                                "info": os.getenv(
                                                                  "DATATABLE_INFO_TEXT",
                                                                                                                      "_TOTAL_ 개 중 _START_ - _END_ 표시"
                                                )
                                                  "infoEmpty": os.getenv("DATATABLE_INFO_EMPTY", "표시할 데이터가 없습니다"),
                                                                         "infoFiltered": os.getenv(
                                                                                                   "DATATABLE_INFO_FILTERED",
                                                                                                                                                    "(총 _MAX_ 개 중 필터링됨)"
                                                           )
                                                             "paginate": {
...
# 장치 필터 설정
DEVICE_FILTERS = [
    {"key": "all", "label": os.getenv(
                                      "FILTER_ALL_TEXT", "모든 장치"), "active": True},
                                          {
                                          "key": "firewall",
                                                    ...
                                                    "error_message": os.getenv(
                                                                               "MODAL_ERROR_MESSAGE",
                                                                                                                                ...
                                                                                                                                "no_interfaces_message": os.getenv(
                                                                                                                                                    ...
                                                                                                                                                    "no_policies_message": os.getenv(
                                                                                                                                                                                     "MODAL_NO_POLICIES",
                                                                                                                                                                                         "정책 정보가 없습니다."
                                                                          )
                                                                                "test_data_suffix": os.getenv(
                                                                                                              "MODAL_TEST_DATA_SUFFIX",
                                                                                                                  " (테스트 데이터)")
                                                           )
                                                   }
                                                 ...
                                                 "view_details": os.getenv("BUTTON_VIEW_DETAILS_TEXT", "상세"),
                                                                           "close": os.getenv(
                                                                                                                                                          ...
                                                                                                                                                          "analyze_path": os.getenv(
                                                                                                                                                                                    "BUTTON_ANALYZE_PATH_TEXT",
                                                                                                                                                                                        "경로 분석")
                                                                             )
                                                                                   "packet_sniffer": os.getenv(
                                                                                                               "BUTTON_PACKET_SNIFFER_TEXT",
                                                                                                                                                                        "패킷 스니퍼 실행"
                                                                    )
                                                                  }
                                ...
                                "TEST_MODE_BANNER_MESSAGE",
                                    "현재 테스트 모드로 실행 중입니다. 실제 장비 연결 시 이 메시지가 사라집니다.",
                                            ...
                                            "badge_text": os.getenv("TEST_MODE_BADGE_TEXT", "테스트"),
                                                                                                                                        "device_suffix": os.getenv(
                                                                        "TEST_MODE_DEVICE_SUFFIX",
                                                                        " (테스트 데이터)")
                                                                    )
                                                                       }
...
PERFORMANCE_CONFIG = {
    "datatable_page_length": int(os.getenv("DATATABLE_PAGE_LENGTH", "25")),
                                 "auto_refresh_interval": int(
                                                              os.getenv("DEVICE_AUTO_REFRESH_INTERVAL",
                                                                        "60000")),
                                                                                                             # 밀리
                                         )
