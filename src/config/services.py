                    ...
                    "'unsafe-eval'",
                        "https://cdnjs.cloudflare.com",
                            ...
                            "https://stackpath.bootstrapcdn.com",
                                ...
                                "font-src": ["'sel'", "https://fonts.gstatic.com", "https://cdnjs.cloudflare.com"],
...
API_VERSIONS: Dict[str, str] = {
    "fortigate": os.getenv("FORTIGATE_API_VERSION", "/api/v2"),
                           "fortimanager": os.getenv("FORTIMANAGER_API_VERSION", "/jsonrpc"),
                                                     "fortianalyzer": os.getenv(
                                                                                "FORTIANALYZER_API_VERSION",
                                                                                                                                         "/jsonrpc"
                                                     )
                                                                                                                          "fortisiem": os.getenv(
                                                                                                                                                 "FORTISIEM_API_VERSION",
                                                                                                                                                     "/api/v2.0"
                                                             )
                                                              "fortiweb": "/api/v2.0",
                                                                  "forticlient": "/api/v1",
...
MOCK_ENDPOINTS: Dict[str, str] = {
    "base_url": f"http://localhost:{os.getenv('MOCK_SERVER_PORT', '6666')}",
                                              "fortigate": f"http://localhost:{os.getenv(
                                                                                         'MOCK_SERVER_PORT',
                                                                                             '6666')}/api/v2"
                                                  )
                                                                                                      "system_status": f"http://localhost:{os.getenv(
                                                                                                                                                     'MOCK_SERVER_PORT',
                                                                                                                                                         '6666')}/api/v2/monitor/system/status"
                                                       )
                                                                                                                      "firewall_policy": f"http://localhost:{os.getenv(
                                                                                                                                                                       'MOCK_SERVER_PORT',
                                                                                                                                                                           '6666')}/api/v2/cmdb/firewall/policy"
                                                               )
                                                           }
