...
class ExceptionHandler:
    ...
    def __init__(self, logger_name: str = "exception_handler"):
        self.logger = setup_module_logger(logger_name)
           ...
           def handle_api_exception(self, e: Exception,
                                    api_type: str = "unknown") -> tuple:
                """API 관련 예외 처리"""
        ...
        # 기본 처리
            ...
            def _format_api_error(self, message: str,
                                  api_type: str, status_code: int) -> tuple:
                """API 에러 응답 포맷팅"""
        ...
        self.logger.error(f"Network Error: {message}")
           return format_error_response(message, status_code)
            ...
            def handle_generic_exception(
                                         self, e: Exception, context: str = "") -> tuple:
                """일반적인 예외 처리 (최후의 수단)"""
        # 스택 트레이스 로깅
        ...
        @wraps(func)
           ...
           def wrapper(*args, **kwargs):
                ...
                return exception_handler.handle_api_exception(e, api_type)
                        ...
                        return exception_handler.handle_configuration_exception(
                                                                                e)
