...
class LoggerRegistry:
    ...
    def get_logger(self, name: str, strategy: str = 'basic', log_dir: str = None, log_level: str = None) -> 'UnifiedLogger':
...
class UnifiedLogger:
    ...
    def log_fortigate_connection(self, host: str, status: str, error: Optional[str] = None, context: Optional[Dict[str, Any]] = None):
    ...
    def log_fortimanager_connection(self, host: str, status: str, error: Optional[str] = None, context: Optional[Dict[str, Any]] = None):
