...
class DiagnosticTool:
    ...
    def _check_system(self) -> Dict[str, Any]:
        ...
        # 포트 체크
            ...
            for port in local_ports:
                ...
                network_status["port_checks"][port] = "open" if _result == 0 else "closed"
                sock.close()
    ...
    def _check_logs(self) -> Dict[str, Any]:
        """로그 파일 체크"""
        log_info = {"log_directory": "/app/logs", "files": {}, "recent_errors": []}
    ...
    def _save_diagnosis_report(self):
        ...
        os.makedirs(report_dir, exist_ok=True)
            ...
            _report_file = os.path.join(report_dir, f"diagnosis_{timestamp}.json")

            with open(_report_file, "w", encoding="utf-8") as f:
                json.dump(self.results, f, indent=2, ensure_ascii=False, default=str)

                self.logger.info(f"Diagnosis report saved: {_report_file}")
