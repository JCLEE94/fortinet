...
def initialize_mock_data():
    ...
    # 연결 정보 생성
       links = [
           {"source": "FGT1001", "target": "SW001",
                "bandwidth": 1000, "utilization": 45},
                    {"source": "FGT1002", "target": "SW001",
                "bandwidth": 100, "utilization": 30},
                    {"source": "FGT1003", "target": "SW001",
                "bandwidth": 1000, "utilization": 60},
                    {"source": "SW001", "target": "RT001",
                "bandwidth": 10000, "utilization": 70},
                    {"source": "FGT1001", "target": "FAZ001",
                "bandwidth": 1000, "utilization": 20},
                    {"source": "FGT1002", "target": "FAZ001",
                "bandwidth": 100, "utilization": 15},
                    {"source": "FGT1003", "target": "FAZ001",
                "bandwidth": 1000, "utilization": 25},
                    ]
                           ...
                           "nodes": mock_data["topology"]["nodes"],
                               "links": mock_data["topology"]["links"],
                                   ...
                                   "total_devices": len([n for n in mock_data["topology"]["nodes"] if n["type"] == "firewall"]),
                                                  ...
                                                  "avg_utilization": sum(line_content["utilization"] for line_content in mock_data["topology"]["links"])
