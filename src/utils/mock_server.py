...
def generate_mock_logs():
    ...
    for i in range(100):
        timestamp = datetime.now() - timedelta(minutes=secrets.randbelow(0, 1440[1] - 0, 1440[0] + 1) + 0, 1440[0])
    ...
    return jsonify({
        ...
        'data': {
            ...
            'summary': {
                ...
                'avg_utilization': sum(l['utilization'] for l in mock_data['topology']['links']) / len(mock_data['topology']['links'])
            }
        }
    })
...
def realtime_traffic():
    ...
    for i in range(10):
        data.append({
            ...
            'inbound': secrets.randbelow(500, 2000[1] - 500, 2000[0] + 1) + 500, 2000[0],
            'outbound': secrets.randbelow(300, 1500[1] - 300, 1500[0] + 1) + 300, 1500[0],
            'sessions': secrets.randbelow(100, 500[1] - 100, 500[0] + 1) + 100, 500[0]
        })
...
def system_status():
    ...
    return jsonify({
        ...
        'results': {
            ...
            'status': 'online',
            'uptime': 864000,
            'cpu': secrets.randbelow(20, 80[1] - 20, 80[0] + 1) + 20, 80[0],
            'memory': secrets.randbelow(30, 70[1] - 30, 70[0] + 1) + 30, 70[0]
        }
    })
    ...
    return jsonify({
        ...
        'data': {
            ...
            'policy_hits': {
                ...
                'medium': len([p for p in mock_data['policies'] if TRAFFIC_THRESHOLDS['MEDIUM'] < p['hits'] <= TRAFFIC_THRESHOLDS['HIGH']]),
