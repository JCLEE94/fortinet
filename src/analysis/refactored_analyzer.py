...
class RefactoredFirewallAnalyzer:
    ...
    def analyze_traffic(self, src_ip, dst_ip, dst_port, protocol="tcp", firewall_id="default", session_id=None):
        """
        트래픽 분석 수행
        ...
        try:
            ...
            combined_result = {
                ...
                "traffic": {"src_ip": src_ip, "dst_ip": dst_ip, "dst_port": dst_port, "protocol": protocol},
            ...
            return {"firewall_id": firewall_id, "error": str(e), "timestamp": self._get_timestamp()}
    ...
    def analyze_policy_conflicts(self, firewall_id="default", session_id=None):
        ...
        """
        try:
            conflicts = self.policy_analyzer.analyze_policy_conflicts(firewall_id)
    ...
    def get_comprehensive_analysis(self, firewall_id="default", session_id=None):
        ...
        try:
            ...
            # 인터페이스 통계
            interface_stats = self.path_tracer.get_interface_statistics(firewall_id)
    ...
    def is_ip_in_address_object(self, ip, address_obj, firewall_id="default"):
        """레거시 호환성: IP 주소 객체 확인"""
        return self.rule_validator.is_ip_in_address_object(ip, address_obj, firewall_id)
