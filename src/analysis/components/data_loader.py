    ...
    def _load_from_fortimanager(self, firewall_id):
        ...
        # 주소 객체 및 서비스 객체 로드
                self._addresses[firewall_id] = self.fortimanager_client.get_firewall_addresses(
                                                                                               adom)
            self._address_groups[firewall_id] = self.fortimanager_client.get_firewall_address_groups(
                                                                                                     adom)
            self._services[firewall_id] = self.fortimanager_client.get_firewall_services(
                                                                                         adom)
            self._service_groups[firewall_id] = self.fortimanager_client.get_firewall_service_groups(
                                                                                                     adom)
