...
@api_bp.route("/settings", methods=["GET"])
                                                         ...
                                                         "WEB_APP_HOST": os.getenv("WEB_APP_HOST", "0.0.0.0"),
                                                                                   "WEB_APP_PORT": os.getenv(
                                                                                    ...
                                                                                    # FortiManager 설정 (인증 정보 포함)
                                                                                                                            "FORTIMANAGER_DEMO_HOST": os.getenv(
                                                                                                                                                                "FORTIMANAGER_DEMO_HOST",
                                                                                                                                                                    ""
                                                              )
                                            "FORTIMANAGER_PORT": os.getenv("FORTIMANAGER_PORT", "14005"),
                                                                           "FORTIMANAGER_DEMO_USER": os.getenv(
                                                                                                               "FORTIMANAGER_DEMO_USER",
                                                                                                                                                                                              ""
                                                                           )
                                                                                                                                                                        "FORTIMANAGER_DEMO_PASS": os.getenv(
                                                                                                                                                                                                            "FORTIMANAGER_DEMO_PASS",
                                                                                                                                                                                                                ""
                                                                                    )
                                                                                                                                                                                "FORTIMANAGER_TIMEOUT": os.getenv(
                                                                                                                                                                                                                  "FORTIMANAGER_TIMEOUT",
                                                                                                                                                                                                                      "30"
                                                                                        )
                                                                                          "FORTIMANAGER_VERIFY_SSL": os.getenv(
                                                                                                                               "FORTIMANAGER_VERIFY_SSL",
                                                                                                                                   "false")
                                                            )
                                                                                                          "FORTIMANAGER_DEFAULT_ADOM": os.getenv(
                                                                                                                                                 "FORTIMANAGER_DEFAULT_ADOM",
                                                                                                                                                     "root")
                                                         )
                                                       # FortiGate 설정
        "FORTIGATE_HOST": os.getenv("FORTIGATE_HOST", ""),
                                    "FORTIGATE_PORT": os.getenv("FORTIGATE_PORT", "443"),
                                                                "FORTIGATE_USERNAME": os.getenv(
                                                                                                "FORTIGATE_USERNAME",
                                                                                                                                                                    "admin"
                                                                )
                                                                                                                                                "FORTIGATE_PASSWORD": os.getenv(
                                                                                                                                                                                "FORTIGATE_PASSWORD",
                                                                                                                                                                                    ""
                                                                        )
                                                                                                                                                                "FORTIGATE_TIMEOUT": os.getenv(
                                                                                                                                                                                               "FORTIGATE_TIMEOUT",
                                                                                                                                                                                                   "30"
                                                                                )
                                                                                                                                                                      "FORTIGATE_VERIFY_SSL": os.getenv(
                                                                                                                                                                                                        "FORTIGATE_VERIFY_SSL",
                                                                                                                                                                                                            "false"
                                                                                   )
                                                  # 보안 임계값
                                                                                                                                                                            "TRAFFIC_HIGH_THRESHOLD": os.getenv(
                                                                                                                                                                                                                "TRAFFIC_HIGH_THRESHOLD",
                                                                                                                                                                                                                    "5000"
                                                                                      )
                                            "TRAFFIC_MEDIUM_THRESHOLD": os.getenv("TRAFFIC_MEDIUM_THRESHOLD", "1000"),
                                                                                  "RESPONSE_TIME_WARNING": os.getenv(
                                                                                                                     "RESPONSE_TIME_WARNING",
                                                                                                                                                                                                           "1000"
                                                                                  )
                                                                                     "RESPONSE_TIME_CRITICAL": os.getenv(
    ...
    @api_route(rate_limits={"max_requests": 10, "_window": 60})
    @require_json_data
...
@api_bp.route("/system/stats", methods=["GET"])
    ...
    @rate_limit(max_requests=20, _window=60)
...
def test_fortimanager_connection(data):
                        ...
                        connection_data = {
                            "auth_method": "token",
                                "adom_count": len(adom_list) if adom_list else 0,
                                                                                                    "adoms": [adom.get(
                                                      "name",
                                                      "Unknown") for adom in (adom_list or [])][:5]
                                                  )
    ...
    try:
        ...
        try:
            ...
            _fm_client = api_manager.get_fortimanager_client()
                if not fm_client:
        ...
        # Production mode - attempt real data
            ...
            try:
                                                       ...
                                                       "current": int(avg_cpu),
                                                                      "average": int(avg_cpu * 0.9),
                                                                          "peak": int(avg_cpu * 1.2),
                                                                              "history": [int(
                                                                                              avg_cpu + random.randint(-10,
                                                                                                            10)) for _ in range(24)]
                                                                )
                                                        },
                                                                "memory_usage": {
                                                                ...
                                                                "network_traffic": {
                                                                    "incoming": int(total_traffic_in),
                                                                                    "outgoing": int(total_traffic_out),
                                                                                       ...
                                                                                       "incoming": [
                                                                                           int(
                                                                                                                                                                                          total_traffic_in + random.randint(-50,
                                                                                                                                                                                              50)) for _ in range(24
                                                                                           )
                                                        ],
                                                            "outgoing": [
                                                                                                                                int(
                                                                    total_traffic_out + random.randint(-50,
                                                                    50)) for _ in range(24
                                                                )
                                                    ],
                                                        },
                ...
                if api_manager and api_manager.fortimanager_client:
                    _fm_client = api_manager.fortimanager_client
                    try:
                        if fm_client.login():
                            # 위협 통계 가져오기
                                    ...
                                    monitoring_data["threat_count"] = {
                                        "today": threat_stats.get("today", 0),
                                                              "this_week": threat_stats.get("week", 0),
                                                                                            "this_month": threat_stats.get(
                                                                                                                           "month",
                                                                                                                                                                                                                           0
                                                                                            )
                                                                                                                                                                                                          "by_type": threat_stats.get(
                                                                                                                                                                                                                                      "by_type",
                                                                                                                                                                                                                                          {}
                                                                                                     )
                    ...
                    bandwidth_usage = {
                        "total_capacity": 1000,
                            "current_usage": stats.get("total_bandwidth_in", 0) + stats.get("total_bandwidth_out", 0),
                                                       "peak_usage": (
                                                              stats.get("total_bandwidth_in",
                                                                        0) + stats.get("total_bandwidth_out",
                                                                                                                                      0)) * 1.2
                                                   )
                                                                                                      "average_usage": (
                                                                                                                        stats.get("total_bandwidth_in",
                                              ...
                                              "wan1": stats.get("total_bandwidth_out", 0),
                                                                "internal": stats.get("total_bandwidth_in", 0),
                                                                                     ...
                                                                                     "history": [
                                                                                         stats.get(
                                                                                             "total_bandwidth_in",
                                                                    100) + stats.get("total_bandwidth_out",
                                                ...
                                                "total_devices": len(nodes),
                                                                     "online_devices": len([n for n in nodes if n["status"] == "online"]),
                                                                                       "total_links": len(links),
                                                                                                          "avg_utilization": (
                                                                                                                      sum(line_content["utilization"] for line_content in links) / len(links) if links else 0
                                                                    ),
                                                                        },
                                                                            },
                                                "data_source": "real",
...
# Additional API endpoints that are missing and called by frontend
    ...
    @rate_limit(max_requests=5, _window=60)
    ...
    try:
        ...
        try:
            ...
            logger.error(f"Token generation failed: {e}")
                return (
                        jsonify({"success": False, "message": f"Token generation failed: {str(e)}"}),
                                500,
                                    )
    ...
    @rate_limit(max_requests=10, _window=60)
    ...
    try:
                    ...
                    "name": "default",
                        "status": "valid",
                            "expires": (datetime.now() + timedelta(days=90)).isoformat(),
                                    ...
                                    "ssl_enabled": True,
                                                                                "verify_ssl": unified_settings.get_service_config(
                                            "fortimanager").get("verify_ssl",
                                            False)
                                        )
                                                                      }
        ...
        return jsonify({"success": True, "data": ssl_status})
            ...
            return (
                    jsonify({"success": False, "message": f"Failed to get SSL status: {str(e)}"}),
                            500,
                                )
...
@api_bp.route("/system/info", methods=["GET"])
    ...
    try:
        ...
        if psutil_available:
            ...
            return (
                    jsonify({"success": False, "message": f"Failed to get system info: {str(e)}"}),
                            500,
                                )
...
def analyze_traffic():
    ...
    try:
        ...
        try:
            ...
            # Perform analysis
                _result = analyzer.analyze_path(src_ip=src_ip, dst_ip=dst_ip, protocol=protocol, port=port)
