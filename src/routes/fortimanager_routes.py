...
logger = get_logger(__name__)
    ...
    try:
            ...
            if fm_client.test_token_auth():
                ...
                try:
                    adom_list = fm_client.get_adom_list()
                        ...
                        address_count = len(
                                            address_objects) if address_objects else 0
        ...
        return (
                jsonify({"success": False, "message": str(
                        e), "data": {"status": "error"}}),
                            500,
                            )
...
@fortimanager_bp.route("/address-objects", methods=["GET"])
    ...
    try:
        api_manager = get_api_manager()
            ...
            if fm_client and fm_client.test_token_auth():
                ...
                return jsonify(
                               {"success": False, "message": "FortiManager not available"})
                    ...
                    topology_devices.append(
                                            ...
                                            "id": device.get(
                                                             "serial",
                                                                                                                                  device.get(
                                                                                                                                             "hostname",
                                                                                                                                                 f"device_{len(topology_devices)}")
                                                                 )
                                                        ),
    ...
    try:
        data = request.get_json()
            ...
            if client:
                _result = client.start_packet_capture(
    ...
    try:
        data = request.get_json()
            ...
            if client:
                _result = client.stop_packet_capture(data.get("capture_id"))
                else:
                    return jsonify({"error": "Device not found"}), 404
...
def get_advanced_hub():
    ...
    if _advanced_hub is None:
        api_manager = get_api_manager()
            _fm_client = api_manager.get_fortimanager_client() if api_manager else None
    ...
    try:
        ...
        # Convert async call to sync using asyncio.run
            ...
            try:
                ...
                _result = loop.create_task(hub.initialize())
                    else:
                        _result = asyncio.run(hub.initialize())
...
# Policy Orchestration Routes
    ...
    try:
        data = request.get_json()
            ...
            _result = hub.analyze_policy_conflicts(device=data.get("device"), adom=data.get("adom", "root"))
    ...
    try:
        data = request.get_json()
            ...
            _result = hub.optimize_policies(device=data.get("device"), adom=data.get("adom", "root"))
    ...
    try:
        data = request.get_json()
            ...
            _result = hub.get_policy_recommendations(device=data.get("device"), adom=data.get("adom", "root"))
    ...
    try:
        ...
        # Convert async call to sync using asyncio.run
            ...
            try:
                ...
                if loop.is_running():
                    # If already in async context, create new task
                _result = loop.create_task(hub.perform_threat_hunting(data.get("parameters", {})))
                    else:
                        _result = asyncio.run(hub.perform_threat_hunting(data.get("parameters", {})))
                    except Exception as e:
                        logger.error(f"Operation failed: {e}")
                                        ...
                                        "insight_id": anomaly.insight_id,
                                            "timestamp": anomaly.timestamp.isoformat(),
                                                                                     "severity": anomaly.severity,
                                                                                         "title": anomaly.title,
                                                                             "description": anomaly._description,
...
# ==========================================
    ...
    try:
        policy_data = request.get_json()
            ...
            if not fm_client:
                ...
                _result = fm_client.create_firewall_policy(policy_data, adom)
            if _result:
                return jsonify(
                               {
                               "success": True,
    ...
    @rate_limit(max_requests=15, _window=60)
    ...
    try:
        policy_data = request.get_json()
            ...
            if not fm_client:
                ...
                _result = fm_client.update_firewall_policy(policy_id, policy_data, adom)
            if _result:
                return jsonify(
                               {
                               "success": True,
    ...
    try:
        adom = request.args.get("adom", "root")
            ...
            if not fm_client:
                ...
                _result = fm_client.delete_firewall_policy(policy_id, adom)
            if _result:
                return jsonify(
                               {
                               "success": True,
