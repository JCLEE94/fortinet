...
class Role:
    ...
    def __init__(self, name: str, description: str, permissions: Set[Permission], 
                 priority: int = 0, inherits_from: List[str] = None):
        """
        Initialize a role
...
class RBACManager:
    ...
    def save_configuration(self):
        ...
        config = {
            "custom_roles": [
                role.to_dict() for name, role in self.roles.items()
                if name not in ["super_admin", "admin", "security_admin", 
                               "network_operator", "analyst", "itsm_user", 
                               "viewer", "guest"]
            ],
    ...
    def create_role(self, name: str, description: str, 
                   permissions: List[str], priority: int = 0,
    ...
    def create_resource_policy(self, resource: str, owner: str, 
