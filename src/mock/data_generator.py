        ...
        return {
            "total_devices": random.randint(50, 200),
                                            "uptime_percentage": round(random.uniform(95.0, 99.9), 1),
                                                                       "network_traffic": f"{random.randint(
                                                                                                            1,
                                                                                                                                                                                       100
                                                                       )
                                                                                                                                                                          "active_alerts": random.randint(
                                                                                                                                                                                                          0,
                                                                                                                                                                                                              15
                                                                                     )
                                                                                                                                                                                  "cpu_usage": round(
                        ...
                        "name": f"FW-{random.choice(self.locations)}-{i+1:02d}",
                                                "type": random.choice(self.device_types),
                                                                      "status": random.choice(self.statuses),
                                                                                              "ip_address": f"192.168.{random.randint(
                                                                                                                                      1,
                                                                                                                                          255)}.{random.randint(1,
                                                                                                                                              254)}"
                                                    )
                                                                "location": random.choice(self.locations),
                                                                                          "uptime": f"{random.randint(
                                                                                                                      1,
                                                                                                                                                                                                                    365
                                                                                          )
                                                                                                "version": f"{random.randint(
                                                                                                                             6,
                                                                                                                                 7)}.{random.randint(0,
                                                                                                                                                     4)}.{random.randint(0,
                                                                                                                                                         9)}"
                                                                                                          ...
                                                                                                          "last_seen": datetime.now(
                                                                                                                                    ) - timedelta(minutes=random.randint(0,
                                                                                                                                                  60))
                                                         )
                                                         "cpu_usage": round(random.uniform(5.0, 95.0), 1),
                                                                            ...
                                                                            "interfaces": random.randint(8, 48),
                                                                                                         "active_sessions": random.randint(
                                                                                                                                                                                                                                                    100,
                                                                                                                                                                                                                                                        5000)
                                                                                                         )
                                                                                                             }
                        ...
                        "destination_ip": f"192.168.{random.randint(1, 255)}.{random.randint(1, 254)}",
                                                                    "timestamp": datetime.now(
                                                                                                    ...
                                                                                                    1440))
                                                                                                                                ...
                                                                                                                                "device": f"FW-{random.choice(
                                                                                                                                                              self.locations)}-{random.randint(1,
                                                                                                                                                                                               20):02d}"
                                                                    )
        ...
        return {
            "cpu_history": [random.randint(10, 80) for _ in range(24)],
                                           "memory_history": [random.randint(30, 85) for _ in range(24)],
                                                                             "network_history": [random.randint(
                                                                                                                1,
                                                                                                                                                                                                 100) for _ in range(24
                                                                             )
                                                                                                                                                                          "active_connections": random.randint(
                                                                                                                                                                                                               1000,
                                                                                                                                                                                                                   10000
                                                                                     )
                                                                                                                                                                                        "threats_blocked": random.randint(
                                                                                                                                                                                                                          0,
                                                                                                                                                                                                                              50
                                                                                            )
                                                                                           "bandwidth_usage": {
                                                                                               "upload": f"{random.randint(
                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                              50)} Mbps"
                                                                                               )
                                                                                                                                                                                                      "download": f"{random.randint(
                                                                                                                                                                                                                                    10,
                                                                                                                                                                                                                                        200)} Mbps"
                                                                                                   )
                                                                                                 },
