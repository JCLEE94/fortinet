...
from .policy_automation import PolicyAutomationEngine, DeploymentReport
...
class ITSMAutomationService:
    ...
    def get_service_status(self) -> Dict:
        ...
        status = {
            ...
            'success_rate': (
                ...
                max(1, self.service_stats['total_requests_processed']) * 100
            ),
            ...
            'automation_engine_status': {
                ...
                'deployment_history_count': len(self.automation_engine.deployment_history) if self.automation_engine else 0
            }
        }
    ...
    async def test_itsm_connection(self) -> Dict:
        ...
        if not self.connector:
            return {
                'success': False,
                'error': 'ITSM connector not configured'
            }
