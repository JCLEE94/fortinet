...
class FortiManagerAnalyzer:
            ...
            for packet in packets:
                ...
                if is_fortimanager:
                    ...
                    if 'is_fortimanager' not in packet:
                        ...
                        packet['fortimanager_direction'] = 'outbound' if src_port in self.fortimanager_ports else 'inbound'
    ...
    def _analyze_response_times(self, packets: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        try:
            ...
            if response_times:
                ...
                return {'total_pairs': 0, 'message': '완전한 요청/응답 쌍을 찾을 수 없음'}
    ...
    def _generate_performance_recommendations(self, response_times: Dict[str, Any], requests_per_second: float) -> List[str]:
        """
        성능 개선 권장사항 생성
