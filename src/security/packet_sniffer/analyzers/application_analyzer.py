...
class ApplicationAnalyzer:
    ...
    def _check_application_security(self, analysis: Dict[str, Any], payload: bytes, packet_info: Dict[str, Any]) -> List[Dict[str, Any]]:
        """애플리케이션 보안 검사"""
        issues = []
