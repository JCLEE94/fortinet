...
class ApplicationAnalyzer:
        ...
        try:
            ...
            if payload.startswith(b"SSH-"):
                ...
                if len(version_str.split("-")) >= 3:
                    ...
                    analysis.update({"protocol_version": parts[1], "software_version": "-".join(parts[2:])})
    ...
    def _analyze_http(self, payload: bytes, packet_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if first_line.startswith(("GET ", "POST ", "PUT ", "DELETE ", "HEAD ", "OPTIONS ")):
                ...
                if len(parts) >= 3:
                    analysis.update({"type": "request", "method": parts[0], "uri": parts[1], "version": parts[2]})
    ...
    def _analyze_imap(self, payload: bytes, packet_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if payload_str.startswith(("* ", "+ ")):
                ...
                analysis.update({"type": "tagged_response", "tag": tag, "status": status, "message": message})
            ...
            # IMAP 명령어 분석
                ...
                if len(parts) >= 2:
                    ...
                    analysis.update({"type": "command", "tag": tag, "command": command, "arguments": args})
    ...
    def _analyze_mqtt_subscribe(self, payload: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"packet_id": packet_id, "topics": topics, "topic_count": len(topics)}
