    ...
    def _analyze_ip_layer(self, packet_data: bytes, packet_info: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if version == 4:
                ...
                return {'version': version, 'error': f'Unknown IP version: {version}'}
    ...
    def _get_current_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'top_ports': [{'port': p[0], 'service': self.WELL_KNOWN_PORTS.get(p[0], 'unknown'), 'count': p[1]} for p in top_ports]
            }
