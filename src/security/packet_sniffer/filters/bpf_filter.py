    ...
    def _parse_condition(self, condition: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if port_range_match:
                ...
                return {'type': 'port_range', 'start': start_port, 'end': end_port}
    ...
    def _evaluate_filter(self, filter_expr: Dict[str, Any], packet_info: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if expr_type == 'always_true':
                ...
                return self._ip_in_network(packet_info.get('src_ip'), network) or \
                       self._ip_in_network(packet_info.get('dst_ip'), network)
