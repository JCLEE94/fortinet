...
class DeepInspector:
    ...
    def _detect_security_threats(self, packet: Dict[str, Any], payload: bytes) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # 백도어 시그니처
            backdoor_strings = [
                'metasploit', 'meterpreter', 'backdoor', 'rootkit',
                'keylogger', 'trojan', 'netcat'
            ]
            ...
            # 익스플로잇 킷
            exploit_patterns = [
                'exploit', 'payload', 'rop', 'heap spray',
    ...
    def _detect_malware_indicators(self, packet: Dict[str, Any], payload: bytes) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # 알려진 멀웨어 시그니처
            malware_signatures = [
                'wannacry', 'petya', 'conficker', 'stuxnet',
                'emotet', 'trickbot', 'ransomware'
            ]
