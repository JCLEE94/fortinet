...
logger = logging.getLogger(__name__)
    ...
    def export_packets(
        ...
        try:
            ...
            # 필터 정보를 메타데이터로 추가
            _result = self.export_packets(filtered_packets, output_path)
    ...
    def _convert_analysis_to_csv_row(self, analysis_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        anomalies = analysis_result.get("anomalies", [])
            anomaly_summary = (
                               "; ".join(
                                         [f"{anomaly.get('type',
                                                     'unknown')}: {anomaly.get('description',
            ...
            "timestamp": analysis_result.get("timestamp", ""),
                                             "src_ip": packet_info.get("src_ip", ""),
                                                                       "dst_ip": packet_info.get("dst_ip", ""),
                                                                                                 "src_port": packet_info.get(
                                                                                                                                                                                                                              "src_port",
                                                                                                                                                                                                                                  "")
                                                                                                 )
                                                                                                                                                                                                              "dst_port": packet_info.get(
                                                                                                                                                                                                                                          "dst_port",
                                                                                                                                                                                                                                              "")
                                                                                                       )
                                                                                                                                                                                                                      "protocol": packet_info.get(
                                                                                                                                                                                                                                                  "protocol",
                                                                                                                                                                                                                                                      "")
                                                                                                           )
                                                                                                        "packet_size": packet_info.get(
                                                                                                                                       "size",
                                                                                                                                                                                                   ""
                                                                                )
                                                                                                                                                                      "analysis_type": analysis_result.get(
                                                                                                                                                                                ...
                                                                                                                                                                                "result_summary": analysis_result.get(
                                                                                                                                                                                                                      "summary",
                                                                                                                                                                                                                          ""
                                                                                        )
