...
class CSVExporter:
    ...
    def export_analysis_results(self, analysis_results: List[Dict[str, Any]], 
        ...
        try:
            ...
            columns = [
                ...
                'protocol', 'packet_size', 'analysis_type', 'result_summary',
                'security_issues', 'anomalies', 'confidence_score'
            ]
    ...
    def _apply_filter(self, packets: List[Dict[str, Any]], 
    ...
    def _packet_matches_filter(self, packet: Dict[str, Any], 
    ...
    def create_summary_report(self, packets: List[Dict[str, Any]], 
                             output_path: str) -> Dict[str, Any]:
