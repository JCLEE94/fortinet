...
class ReportExporter:
    ...
    def generate_html_report(self, analysis_data: Dict[str, Any], 
                           output_path: str, include_charts: bool = True) -> Dict[str, Any]:
        """
    ...
    def generate_executive_summary(self, analysis_data: Dict[str, Any], 
                                 output_path: str) -> Dict[str, Any]:
        """
        경영진용 요약 보고서 생성
    ...
    def generate_security_report(self, analysis_data: Dict[str, Any], 
                               output_path: str) -> Dict[str, Any]:
        """
        보안 중심 분석 보고서 생성
    ...
    def generate_performance_report(self, analysis_data: Dict[str, Any], 
                                  output_path: str) -> Dict[str, Any]:
        """
        성능 분석 보고서 생성
