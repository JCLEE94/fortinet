...
logger = logging.getLogger(__name__)
    ...
    def generate_html_report(
        ...
        try:
            ...
            # HTML 내용 생성
                _html_content = self._generate_html_content(report_data, include_charts)
        ...
        try:
            ...
            # HTML 요약 보고서 생성
                _html_content = self._generate_executive_html(summary_data)
    ...
    def generate_security_report(self, analysis_data: Dict[str, Any], output_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 보안 보고서 HTML 생성
                _html_content = self._generate_security_html(security_data)
    ...
    def generate_performance_report(self, analysis_data: Dict[str, Any], output_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 성능 보고서 HTML 생성
                _html_content = self._generate_performance_html(performance_data)
                                                                                                                       ...
                                                                                                                       "duration_hours": duration.total_seconds() / 3600,
                                                                                                                                                                    ...
                                                                                                                                                                    "hourly_distribution": dict(hourly_distribution),
                                                                                                                                                                          "daily_distribution": dict(daily_distribution),
                                                                                                                                                                              "peak_hour": (
                                                                                                                                              max(hourly_distribution.items(),
                                                                                                                                                  key=lambda x: x[1])[0] if hourly_distribution else None)
                                                                    )
                                                                        ...
                                                                        chart_scripts = (
                                                                                     self._get_chart_scripts() if include_charts else "",
                                                                                                                                                                    ...
                                                                                                                                                                    generation_time=report_data.get(
                                                                                                                                                                            ...
                                                                                                                                                                            total_packets=basic_stats.get(
                                                                                                                                                                                                          "total_packets",
                                                                                                                                                                                                              0
                                                                                      )
                                                                                        total_bytes_mb=basic_stats.get(
                                                                                                                       "total_bytes",
                                                                                                                           0) / (1024 * 1024)
                                                                )
                                                   security_issues=security_stats.get("total_issues", 0),
                                                                                      anomalies=anomaly_stats.get(
                                                                                                                  "total_anomalies",
                                                                                                                                                                                                            0
                                                                                      )
