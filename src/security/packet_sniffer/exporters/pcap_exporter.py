...
class PCAPExporter:
    ...
    def export_packets(self, packets: List[Dict[str, Any]], output_path: str,
    ...
    def export_filtered_packets(self, packets: List[Dict[str, Any]], 
                               filter_expression: str, output_path: str) -> Dict[str, Any]:
        """
    ...
    def export_by_protocol(self, packets: List[Dict[str, Any]], 
    ...
    def export_time_sliced(self, packets: List[Dict[str, Any]], 
                          output_dir: str, slice_duration: int = 3600) -> Dict[str, Any]:
        """
    ...
    def _create_ip_header(self, src_ip: str, dst_ip: str, protocol: str) -> bytes:
        ...
        return struct.pack('>BBHHHBBH4s4s',
            ...
            flags_fragment, ttl, proto_num, checksum,
            src_addr, dst_addr
        )
    ...
    def _apply_bpf_filter(self, packets: List[Dict[str, Any]], 
                         filter_expression: str) -> List[Dict[str, Any]]:
        """BPF 필터 적용 (간단한 구현)"""
        try:
            # 간단한 필터 파싱 및 적용
            filtered = []
        ...
        try:
            ...
            if 'port' in filter_lower:
                ...
                try:
                    ...
                    return (packet.get('src_port') == port_num or 
                           packet.get('dst_port') == port_num)
                except ValueError:
                    pass
            ...
            if 'host' in filter_lower:
                ...
                return (packet.get('src_ip') == ip_match or 
                       packet.get('dst_ip') == ip_match)
    ...
    def _write_metadata_file(self, metadata_path: str, packets: List[Dict[str, Any]], 
                           exported_count: int):
        """메타데이터 파일 작성"""
        try:
            metadata = {
