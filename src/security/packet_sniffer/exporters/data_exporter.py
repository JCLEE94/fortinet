...
class DataExporter:
    ...
    def export_to_json(self, packets: List[Dict[str, Any]], session_id: str, 
    ...
    def export_to_csv(self, packets: List[Dict[str, Any]], session_id: str,
        ...
        try:
            ...
            if custom_fields:
                ...
                fieldnames = [
                    'id', 'timestamp', 'time', 'src_ip', 'dst_ip', 'protocol',
                    'src_port', 'dst_port', 'length', 'info', 'flags', 'payload_preview'
                ]
    ...
    def export_summary_json(self, summary_data: Dict[str, Any], session_id: str,
                           filename: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def export_filtered_data(self, packets: List[Dict[str, Any]], 
                           filter_criteria: Dict[str, Any],
                           export_format: str, session_id: str,
                           filename: Optional[str] = None) -> Dict[str, Any]:
        """
        필터링된 데이터 내보내기
    ...
    def _apply_filters(self, packets: List[Dict[str, Any]], 
