...
class JSONExporter:
            ...
            if self.compress:
                ...
                with gzip.open(output_path, 'wt', encoding='utf-8') as f:
                    json.dump(json_data, f, indent=self.indent, 
                             ensure_ascii=self.ensure_ascii, default=self._json_serializer)
    ...
    def export_analysis_results(self, analysis_results: List[Dict[str, Any]], 
                               output_path: str,
                               include_raw_packets: bool = False) -> Dict[str, Any]:
        """
        분석 결과를 JSON으로 내보내기
    ...
    def export_statistics(self, statistics: Dict[str, Any], output_path: str,
                         include_charts_data: bool = True) -> Dict[str, Any]:
        """
        통계 데이터를 JSON으로 내보내기
    ...
    def _process_analysis_result(self, result: Dict[str, Any], 
                                include_raw_packets: bool) -> Dict[str, Any]:
        """분석 결과 처리"""
...
# 팩토리 함수
def create_json_exporter(indent: Optional[int] = 2, ensure_ascii: bool = False,
                        compress: bool = False) -> JSONExporter:
    """JSON 내보내기 인스턴스 생성"""
