...
from .packet_sniffer.base_sniffer import MockDataGenerator, PacketInfo, SnifferConfig
from .packet_sniffer.device_manager import DeviceManager
from .packet_sniffer.packet_capturer import CaptureFilter, PacketCapturer, create_packet_capturer
from .packet_sniffer.session_manager import SessionManager, create_capture_session, get_session_manager
...
class PacketSnifferAPI:
    ...
    def get_latest_packets(
        ...
        try:
            ...
            return {
                ...
                "packets": packets,
                "count": len(packets),
                "total_available": self.session_manager.get_session(session_id).get_packet_count()
    ...
    def analyze_packet_content(self, packet: Dict[str, Any]) -> Dict[str, Any]:
        """패킷 내용 심층 분석"""
        try:
            analysis_result = {"protocol_analysis": None, "http_analysis": None, "tls_analysis": None}
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": True,
                "metrics": {"capturer": capturer_metrics, "sessions": session_stats, "timestamp": time.time()},
            }
