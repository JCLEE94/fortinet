...
class MonitoringConfig:
    ...
    def add_config_watcher(self, callback):
        ...
        try:
            ...
            # API 성능 설정
            _api_data = data.get("api_performance", {})
                api_thresholds = {}
            ...
            api_config = APIPerformanceConfig(
                                              collection_interval=api_data.get("collection_interval", 5.0),
                                                                               max_history=api_data.get(
                                                                                                        "max_history",
                                                                                                                                                                                           1000
                                                                               )
                                                                                                                                                    auto_optimization=api_data.get(
                                                                                                                                                                                   "auto_optimization",
                                                                                                                                                                                       True
                                                                          )
            ...
            security_data = data.get("security_scan", {})
                security_config = SecurityScanConfig(
                                                     scan_interval=security_data.get("scan_interval", 3600.0),
                                                                                     max_history=security_data.get(
                                                                                                               "max_history",
                                                                                                                                                                                                    500
                                                                                 )
                                                                                                                                                                      auto_fix=security_data.get(
                                                                                                                                                                                                 "auto_fix",
                                                                                                                                                                                                     True
                                                                                   )
            ...
            recovery_data = data.get("auto_recovery", {})
                recovery_config = AutoRecoveryConfig(
                                                     check_interval=recovery_data.get("check_interval", 30.0),
                                                                                      max_history=recovery_data.get(
                                                                                                                "max_history",
                                                                                                                                                                                                      1000
                                                                                  )
                                                                                                                                                                      enabled=recovery_data.get(
                                                                                                                                                                                                "enabled",
                                                                                                                                                                                                    True
                                                                                   )
                ...
                return {
                    "warning": threshold.warning,
                        "critical": threshold.critical,
                            "unit": threshold.unit,
                                "description": threshold._description,
                                    }
