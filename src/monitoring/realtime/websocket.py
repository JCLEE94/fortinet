        ...
        @self.socketio.on("join_monitoring")
            ...
            # 모니터링 스레드 시작
                if not self.monitoring_clients[room]["monitor_thread"]:
                    thread = threading.Thread(
                                              target=self._monitoring_loop, args=(
                                                  room, device_id), daemon=True)
                    thread.start()
            ...
            room = data.get("room", "default")
                ...
                if room in self.monitoring_clients:
                    self.monitoring_clients[room]["clients"].discard(
                                                                     request.sid)
                                                                   ...
                                                                   "tx_bytes": random.randint(1000000, 10000000),
                                                                       ...
                                                                       "id": random.randint(1000, 9999),
                                                                           ...
                                                                           "critical"]
                                                                             ...
                                                                             "source_ip": f"192.168.{random.randint(
                                                                                                                    1,
