...
class AdvancedFortiGateAPI(BaseApiClient):
    ...
    async def create_ipsec_vpn_tunnel(self, 
    ...
    async def get_nat_policies(self, 
                             policy_type: str = "ipv4",
                             vdom: str = "root") -> List[Dict[str, Any]]:
        """
        NAT 정책 목록 조회
    ...
    async def create_snat_policy(self, 
                               policy_data: Dict[str, Any],
                               vdom: str = "root") -> Dict[str, Any]:
        """Source NAT 정책 생성"""
        # SNAT 설정 추가
    ...
    async def get_security_profiles(self, 
                                  profile_type: str,
                                  vdom: str = "root") -> List[Dict[str, Any]]:
        """
        보안 프로필 목록 조회
    ...
    async def apply_security_profile_to_policy(self, 
                                             policy_id: int,
                                             security_profiles: Dict[str, str],
                                             vdom: str = "root") -> Dict[str, Any]:
        """
        방화벽 정책에 보안 프로필 적용
    ...
    async def get_realtime_logs(self, 
    ...
    async def get_interface_stats(self, 
                                interface_name: str = None,
                                vdom: str = "root") -> Union[List[Dict], Dict[str, Any]]:
        """네트워크 인터페이스 통계 조회"""
        if interface_name:
    ...
    async def detect_security_threats(self, 
                                    time_range: int = 3600,
                                    severity_threshold: str = "medium") -> List[Dict[str, Any]]:
        """
        보안 위협 탐지
...
async def batch_policy_operations(api_client: AdvancedFortiGateAPI,
