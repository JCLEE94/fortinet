...
class PackageManagementMixin:
    ...
    def create_package(self, name: str, devices: List[str], 
                      package_type: str = "pkg", adom: str = "root") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            for device in devices:
                scope.append({
                    "name": device,
                    "vdom": "root"  # Default to root VDOM
                })
    ...
    def update_package(self, package_name: str, updates: Dict[str, Any],
    ...
    def assign_package_to_device(self, package_name: str, device_name: str,
                                vdom: str = "root", adom: str = "root") -> Dict[str, Any]:
        """
    ...
    def unassign_package_from_device(self, package_name: str, device_name: str,
                                    vdom: str = "root", adom: str = "root") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            new_scope = [
                entry for entry in current_scope
    ...
    def add_policy_to_package(self, package_name: str, policy: Dict[str, Any],
                             adom: str = "root") -> Dict[str, Any]:
        """
    ...
    def clone_package(self, source_package: str, new_name: str,
                     adom: str = "root") -> Dict[str, Any]:
        """
