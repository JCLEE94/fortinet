...
class TaskManagementMixin:
    ...
    def wait_for_task(self, task_id: int, timeout: int = 300, poll_interval: int = 5, adom: str = "root") -> Dict[str, Any]:
        """
    ...
    def install_policy_package(self, package_name: str, target_devices: List[str], adom: str = "root") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            response = self._make_api_request(
                "exec",
                f"/securityconsole/install/package",
                data=task_data
            )
