    ...
    def get_system_status(self, adom: str = "root") -> Dict[str, Any]:
        ...
        try:
            ...
            if response and response.get("status", {}).get("code") == 0:
                ...
                return {"status": "error", "message": "Failed to get system status", "response": response}
    ...
    def get_task_status(self, task_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if response and response.get("status", {}).get("code") == 0:
                ...
                return {"status": "error", "message": f"Failed to get task status for {task_id}", "response": response}
