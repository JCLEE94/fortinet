...
class FortiManagerAPIClient(
    ...
    def build_json_rpc_request(
                               self, method: str, url: str, data: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        ...
        """
        payload = {"id": int(time.time()), "method": method,
                             "params": [{"url": url}]}
    ...
    def login(self):
        ...
        # Require credentials if no token
                if not self.username or not self.password:
                    self.logger.error(
                                      "API token or user credentials are required")
                return False
        ...
        success, result, status_code = self._make_request(
            ...
            parsed_success, parsed_data = self.parse_json_rpc_response(result)
                ...
                self.logger.error(
                                  f"FortiManager API login failed: {parsed_data}")
                    return False
        else:
            self.logger.error(
                ...
                try:
                    ...
                    # Check if we got actual data or just permission error
                        if parsed_success or (
                                              isinstance(
                                                         parsed_data,
                                                             dict) and parsed_data.get("status",
                                                                                   {}).get("code") != -1
                                                  )
                                          ):
    ...
    def get_adom_list(self):
        ...
        success, _result = self._make_api_request(method="get", url="/dvmdb/adom", timeout=10)  # 10 second timeout
            ...
            self._cache[cache_key] = (time.time(), result)
                return _result if isinstance(result, list) else []
                else:
        ...
        Args:
            ...
            list: Managed devices or empty list on failure
        """
        success, _result = self._make_api_request(method="get", url=f"/dvmdb/adom/{adom}/device")
        ...
        """
        success, _result = self._make_api_request(method="get", url=f"/dvmdb/adom/{adom}/device/{device_name}")
    ...
    def get_firewall_policies(self, device_name, vdom="root", adom="root"):
        ...
        success, _result = self._make_api_request(
                                                  method="get",
                                                      url = (
                                ...
                                policy_info["match_details"] = {
                                    "policy_id": policy.get("policyid"),
                                                            "policy_name": policy.get("name", "Unnamed"),
                                                                      ...
                                                                      "srcint": policy.get("srcint"),
                                                                                           "dstint": policy.get("dstint"),
    ...
    def get_device_global_settings(self, device_name: str, cli_path: str, adom: str = "root") -> Dict[str, Any]:
        ...
        """
        success,
            _result = self._make_api_request(method="get",
                                             url=f"/pm/config/device/{device_name}/global/{cli_path}")

        if success:
            return _result if isinstance(result, (dict, list)) else {}
                else:
    ...
    def get_device_interfaces(self, device_name, vdom="root", adom="root"):
        ...
        """
        success, _result = self._make_api_request(method="get", url="/sys/status")
    ...
    def get_task_status(self, task_id):
        ...
        """
        success, _result = self._make_api_request(method="get", url=f"/task/task/{task_id}")
                                           ...
                                           "week": stats.get("threats_week", 0),
                                                         "month": stats.get("threats_month", 0),
                                                                            "by_type": stats.get("threat_types", {}),
                                                                                                 "blocked_percentage": stats.get(
                                                                                                                  "blocked_percent",
                                                                                                                                                                            95
                                                                    )
                                                                                 "quarantined_percentage": stats.get(
                                                                                                                     "quarantined_percent",
                                                                                                                         3)
                                                                )
                                                            }
    ...
    def get_device_performance(self, device_name, adom="root"):
        ...
        try:
            success, _result = self._make_api_request(
                                                      method="get",
                                                          url = (
                                                                 f"/monitor/adom/{adom}/device/{device_name}/system/performance",
                                                                  )
                                                          )
                    ...
                    return {
                        "cpu_usage": perf_data.get("cpu", 0),
                                                   "memory_usage": perf_data.get("memory", 0),
                                                                             "session_count": perf_data.get(
                                                                                                            "sessions",
                                                                                                                                                                                             0
                                                                             )
                                                                                                                                                                          "bandwidth_in": perf_data.get(
                                                                                                                                                                                                        "bandwidth_rx",
                                                                                                                                                                                                            0
                                                                                     )
                                                                                                                                                                                  "bandwidth_out": perf_data.get(
                                                                                                                                                                                                                 "bandwidth_tx",
                                                                                                                                                                                                                     0
                                                                                         )
                                                                                              }
    ...
    def get_policies(self, device_name=None, adom="root", package="default"):
        ...
        try:
            ...
            success, _result = self._make_api_request(method="get", url=url)
    ...
    def get_address_objects(self, adom="root"):
        ...
        """
        success, _result = self._make_api_request(method="get", url=f"/pm/config/adom/{adom}/obj/firewall/address")
