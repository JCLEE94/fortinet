...
class APIIntegrationManager:
    ...
    def _connect_fortimanager(self):
        ...
        try:
            ...
            fm_config = {
                ...
                "verify_ssl": os.getenv("FORTIMANAGER_VERIFY_SSL", str(settings.fortimanager.verify_ssl)).lower()
                == "true",
            }
            ...
            self.connection_status["fortimanager"] = {"status": "error", "message": str(e), "last_check": time.time()}
            self.fortimanager_client = None
    ...
    def _connect_fortigate_direct(self):
        ...
        try:
            ...
            if success:
                self.fortigate_clients[device_id] = client
                self.connection_status[device_id] = {"status": "connected", "info": result, "last_check": time.time()}
    ...
    def _create_fortigate_client(self, device_name: str, device_ip: str, device_info: Dict):
        ...
        try:
            ...
            self.connection_status[device_name] = {"status": "error", "message": str(e), "last_check": time.time()}
