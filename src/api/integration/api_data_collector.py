            ...
            try:
                self.fortigate_client = FortiGateAPIClient(
                                                           host=self.config["fortigate"]["host"],
                                                               api_token=self.config["fortigate"].get(
                                                                                                      "token"),
                                                                                                          port=self.config["fortigate"].get(
                                                                                                                                        "port",
                                                                                                                                                                                                                                                  443
                                                                                                      )
                                                                                                 )
                        ...
                        try:
                            self.fortimanager_client = FortiManagerAPIClient(
                                                                 host=self.config["fortimanager"]["host"],
                                                                     username=self.config["fortimanager"].get(
                                                                                                              "username"),
                                                                                                                  password=self.config["fortimanager"].get(
                                                                                                                                                       "password"),
                                                                                                                                                           adom=self.config["fortimanager"].get(
                                                                                                                                                                                            "adom",
                                                                                                                                                                                                "root")
                                                                         )
                                                                                                                                                  port = self.config["fortimanager"].get(
                                                                                                                                                                                         "port",
                                                                                                                                                                                           443)
                                                                             )
                                                                         )
