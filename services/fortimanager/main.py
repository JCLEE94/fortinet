...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://fortimanager:fm123@localhost:5432/fortimanager')
...
class FortiManagerService:
    ...
    def analyze_packet_path(self, source_ip: str, dest_ip: str, protocol: str = 'tcp') -> dict:
        """패킷 경로 분석"""
